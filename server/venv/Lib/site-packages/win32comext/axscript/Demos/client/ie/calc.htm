    ...
    <TABLE>
      <B>
        <TABLE BORDER=2 CELLPADDING=1 CELLSPACING=5 HEIGHT=60 WIDTH=50>
          <CAPTION ALIGN=top><b>Calculator</b>
            <p> </CAPTION>
              <TR>
                <TD ALIGN=MIDDLE COLSPAN=3><INPUT NAME="ReadOut" SIZE=24 TYPE="Text" VALUE="0"
                                                  WIDTH=100%></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD><INPUT NAME="Percent" OnClick="Operation('%', lambda x,y: x*y/100.0)" TYPE="Button"
                           VALUE="  % "></TD>
              </TR>
              ...
              <TR>
                ...
                <TD></TD>
                <TD ALIGN=MIDDLE><INPUT NAME="Plus" OnClick="Operation('+', lambda x,y: x+y)" TYPE="Button"
                                        VALUE="  +  "></TD>
                <TD ALIGN=MIDDLE><INPUT NAME="Minus" OnClick="Operation('-', lambda x,y: x-y)" TYPE="Button"
                                        VALUE="   -   "></TD>
              </TR>
              <TR>
                ...
                <TD></TD>
                <TD ALIGN=MIDDLE><INPUT NAME="Multiply" OnClick="Operation('*', lambda x,y: x*y)" TYPE="Button"
                                        VALUE="  *  "></TD>
                <TD ALIGN=MIDDLE><INPUT NAME="Divide" OnClick="Operation('/', lambda x,y: x/y)" TYPE="Button"
                                        VALUE="   /   "></TD>
              </TR>
              <TR>
                ...
                <TD COLSPAN=3></TD>
                <TD><INPUT NAME="Equals" OnClick="Operation('=', lambda x,y: x)" TYPE="Button"
                           VALUE="  =  "></TD>
              </TR>
        </TABLE></TABLE>
    </B>
