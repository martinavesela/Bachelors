...
<BODY LINK="#FF0000" VLINK="#666666" bgcolor="#FFFFFF" leftmargin=8>
<FONT FACE="ARIAL,HELVETICA" SIZE="2">
  ...
  <P>This is really quite a boring demo, as the Marquee control does everything. However, there is Python code behind
    the buttons that change the speed. This code is all of 2 lines per button!!!
