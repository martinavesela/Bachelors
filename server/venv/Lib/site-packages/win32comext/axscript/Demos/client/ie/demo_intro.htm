...
<H1>
  <MARQUEE BEHAVIOR=SCROLL DIRECTION=LEFT NAME="Marquee1" SCROLLAMOUNT=10 SCROLLDELAY=200
...
<UL>
  <LI><P>This release seems to have broken Aaron's mouse-trace sample. No idea why, and Im supposed to be looking into
    it.
