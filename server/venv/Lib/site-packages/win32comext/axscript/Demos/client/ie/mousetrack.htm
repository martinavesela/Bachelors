...
<FONT SIZE=5>
  <TABLE Border=0>
    <TR VALIGN=MIDDLE>
      <TD>
        <A ID="Image"> <IMG
            ...
            BORDER=0 HEIGHT=113 SRC="file:..\..\..\..\..\win32com\html\image\pycom_blowing.gif" WIDTH=624></A>
    ...
    <TR VALIGN=MIDDLE>
      <TD ALIGN=CENTER VALIGN=MIDDLE><FONT SIZE=5><INPUT
          NAME="TxtLinkDescription" SIZE=50 TYPE="text"></FONT></TD>
    </TR>
  </TABLE>
</FONT>
